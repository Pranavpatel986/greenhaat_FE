...
const PrivacyPolicy = () => {
  return (
      ...
      <p><strong>Note:</strong> Our privacy policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy periodically.</p>
      ...
      <h2 className="text-2xl font-bold mt-4">1. Collection of Personally Identifiable Information and other Information</h2>
      ...
      <h2 className="text-2xl font-bold mt-4">2. Use of Demographic / Profile Data / Your Information</h2>
      ...
      <h2 className="text-2xl font-bold mt-4">Cookies</h2>
      ...
      <h2 className="text-2xl font-bold mt-4">3. Sharing of personal information</h2>
      ...
      <h2 className="text-2xl font-bold mt-4">4. Links to Other Sites</h2>
      <p>Our Website links to other websites that may collect personally identifiable information about you. GreenHaat.com is not responsible for the privacy practices or the content of those linked websites.</p>
      
      <h2 className="text-2xl font-bold mt-4">5. Security Precautions</h2>
      <p>Our Website has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access.</p>
      
      <h2 className="text-2xl font-bold mt-4">6. Your Consent</h2>
      ...
      <h2 className="text-2xl font-bold mt-4">7. Grievance Officer</h2>
      ...
      <p>GreenHaat Agro Pvt Ltd, #535, 2nd Floor, 8th Cross, 3rd Phase JP Nagar, Bangalore Karnataka IN 560078</p>
      <p>Phone: +91- 8050797979</p>
      <p>Email: info@greenhaat.com</p>
      <p>Time: Mon to Fri (10:00 AM to 5:00 PM)</p>
      
      <h2 className="text-2xl font-bold mt-4">8. Questions?</h2>
      <p>Please contact us regarding any questions regarding this statement on the above address.</p>
    </div>
  );
};
